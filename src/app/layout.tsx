  ...
  return (
    ...
    >
     <div className="w-full h-12 flex justify-center items-center">
        <div className={`absolute transition-opacity duration-300 ${showFullHeader ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          <div className="flex items-center justify-center w-12 h-12 bg-black/40 backdrop-blur-sm rounded-full">
              <ChevronDown size={32} className="text-white" />
          </div>
        </div>
        <div className={`w-full flex justify-between items-center px-2 sm:px-4 transition-opacity duration-300 ${showFullHeader ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className="md:hidden absolute top-2 right-2 sm:top-3 sm:right-3">
          <button className="text-white text-2xl p-2 rounded-full bg-black/40 backdrop-blur-sm">&#9776;</button>
        </div>
     </div>
    </header>
  );
