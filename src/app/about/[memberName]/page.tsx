      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold uppercase tracking-wider">{member.name}</h1>
            <p className="text-lg sm:text-xl text-gray-400 mt-2 mb-6">{member.role}</p>
