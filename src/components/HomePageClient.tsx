...
// --- LATEST RELEASES CAROUSEL SUB-COMPONENT ---
...
// --- OTHER VIDEOS CAROUSEL SUB-COMPONENT ---
const OtherVideosCarousel = ({ videos }: { videos: SanityDocument[] }) => {
  if (!videos || videos.length === 0) return null;
  return (
    <div className="mt-16 hidden sm:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
...
// --- LATEST NEWS CAROUSEL SUB-COMPONENT ---
...
// --- PROPS INTERFACE FOR THE MAIN CLIENT COMPONENT ---
...
// --- THE MAIN CLIENT COMPONENT FOR THE HOMEPAGE ---
    ...
    <>
      ...
      <section className="py-9 sm:py-12 bg-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <OtherVideosCarousel videos={initialVideos} />
